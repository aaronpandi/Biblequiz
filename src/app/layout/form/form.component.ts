...
export class FormComponent implements OnInit {
  ...
  constructor(public quizservice: QuizServiceService, private quizrouter: Router, private dp: DatePipe) { }
    ...
    PrepareForTheQuiz(subGroupId: number, ChosenQnLanguageNbr: number) {
      ...
      localStorage.setItem('ChosenSubGroupId', subGroupId.toString());        
      ...
      localStorage.setItem('passPercentage', this.quizservice.passPercentage.toString());
      localStorage.setItem('ChosenQnLanguageNbr', this.quizservice.ChosenQnLanguageNbr.toString());
    ...
    clear(){
      ...
      localStorage.removeItem("ChosenSubGroupId");
      localStorage.removeItem("passPercentage");
      localStorage.removeItem("ChosenQnLanguageNbr");
